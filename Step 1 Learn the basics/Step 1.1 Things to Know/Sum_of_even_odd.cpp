...
Digits mean numbers, not places! That is, if the given integer is "132456", even
digits are 2, 4, and 6, and odd digits are 1, 3, and 5.
...
digits and then the sum of odd digits. Sample Input 1: 132456
